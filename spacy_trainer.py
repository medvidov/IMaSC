...
"""
This is basically the exact same as new_entity.py...
"""

# new entity label
LABEL = ["INSTRUMENT", "SPACECRAFT"]

TRAIN_DATA = prodigy_to_spacy("training_annotations.jsonl")
...
def main(model=None, new_model_name="imasc", output_dir="IMaSC", n_iter=10):
